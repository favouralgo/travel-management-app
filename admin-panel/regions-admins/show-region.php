    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="../countries-admins/show-country.php" style="margin-left: 20px;">Countries</a>
          </li>
          <li class="nav-item">
        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
             ...
             <a  href="create-country.html" class="btn btn-primary mb-4 text-center float-right">Create Country</a>
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
